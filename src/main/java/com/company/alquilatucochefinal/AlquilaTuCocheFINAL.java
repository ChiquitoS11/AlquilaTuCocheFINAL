...
public class AlquilaTuCocheFINAL {
    ...
    public static void main(String[] args) {
        ...
        coches.add(new CocheFINAL("Pokemon", "Gengar", 4, CocheFINAL.Tipo.Gasoil, 500.0, img1, true));
        ...
        coches.add(new CocheFINAL("VideoJuegos", "Kirby", 2, CocheFINAL.Tipo.Gasolina,250.0, img2, true));
        
        ArrayList<URL> img3 = new ArrayList<>();
        rellenarArrayImagenes(img3, "/resources/traumas1.gif");
        coches.add(new CocheFINAL("Anime", "CyberPunk EdgeRunners", 4, CocheFINAL.Tipo.Electrico, 420.0, img3, true));
        ...
        coches.add(new CocheFINAL("VideoJuegos", "Shimakaze", 2, CocheFINAL.Tipo.Gasolina, 150.0, img4, true));
        
        ArrayList<URL> img5 = new ArrayList<>();
        rellenarArrayImagenes(img5, "/resources/noPonerlaV1.jpg");
        coches.add(new CocheFINAL("Anime", "No la he puesto en anios V1", 6, CocheFINAL.Tipo.Electrico, 300.0, img5, true));
        
        ArrayList<URL> img6 = new ArrayList<>();
        rellenarArrayImagenes(img6, "/resources/noPonerlaV2.jpg");
        coches.add(new CocheFINAL("Anime", "No la he puesto en anios V2", 2, CocheFINAL.Tipo.Electrico, 200.0, img6, true));
        
        ArrayList<URL> img7 = new ArrayList<>();
        rellenarArrayImagenes(img7, "/resources/shuna1.jpg");
        coches.add(new CocheFINAL("Anime", "Shuna", 2, CocheFINAL.Tipo.Electrico, 150.0, img7, true));
        ...
        coches.add(new CocheFINAL("Lamborghini", "Shiny", 6, CocheFINAL.Tipo.Electrico, 1000.0, img8, true));
        ...
        coches.add(new CocheFINAL("Anime", "Hatsune Miku", 6, CocheFINAL.Tipo.Electrico, 200.0, img9, true));
        ...
        coches.add(new CocheFINAL("Carrito de Golf", "Fortnite", 4, CocheFINAL.Tipo.Gasolina, 50.0, img10, true));
